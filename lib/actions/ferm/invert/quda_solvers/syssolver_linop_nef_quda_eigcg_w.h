// -*- C++ -*-
/*! Use EigCG or incremental EigCG to solve mdwf linear systems.
 *  Arjun Gambhir
*/

#ifndef __syssolver_linop_quda_nef_eigcg_h__
#define __syssolver_linop_quda_nef_eigcg_h__
...
namespace Chroma
{
  ...
  namespace LinOpSysSolverQUDANEFEIGCGEnv
  {
  ...
  class LinOpSysSolverQUDANEFEIGCG : public LinOpSystemSolverArray<LatticeFermion>
  {
  public:
     ...
     */
    LinOpSysSolverQUDANEFEIGCG(Handle< LinearOperatorArray<T> > A_,
			  Handle< FermState<T,Q,Q> > state_,
			  const SysSolverQUDANEFEIGCGParams& invParam_) : 
      A(A_), invParam(invParam_) 
    {
      START_CODE();
      
      QDPIO::cout << "LinOpSysSolverQUDANEFEIGCG:" << std::endl;
  ...
  private:
    ...
    LinOpSysSolverQUDANEFEIGCG() {}
		...
		const SysSolverQUDANEFEIGCGParams invParam;
